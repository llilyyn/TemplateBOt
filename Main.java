...
public class Main {
    ...
    static String[] farewell = {
        ...
        "Well, that sure was fun! Farewell!",
        "Okay then. It was fun chatting with you. Bye!",
    ...
    public static void main(String[] args) {
        ...
        System.out.println(WHITE_BG + RED_TEXT + "Hello, welcome to Chipotle! I am a chatbot that can give you info on our wonderful menu! Would you like to explore our toppings? Or take a look at our drinks? Or maybe have a peek at some delicious meals?");
        ...
        while (!byeBye && !containsGoodbye(userResp)) {
            ...
            if (next == 2) {
                ...
                if (info.length() == 0) {
                    System.out.println("Sorry, I couldn't find anything about that. Is there anything else you'd like to learn about? Please reply yes or no.");
                    userResp = in.nextLine();
                }
            }
...
public static String toppingsScene(String topping) {
    ...
    public static String getMealPrice(String meal) {
        ...
        return "Sorry, I couldn't find the price for that item. Please specify a meal like burritos, quesadillas, or tacos!";
    }
    ...
    public static String getMealNutrition(String meal) {
        ...
        return "Sorry, I couldn't find the nutritional info for that meal.";
    }
